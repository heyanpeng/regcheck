...
(function () {
    ...
    var _ = window.Utopia = {
         ...
         * Accessors are preserved for the first object only
         */
        ...
        element: {
            ...
            create: function () {
                ...
                if (options.start) {
                    var parent = $(options.start)

                    if (parent.hasChildNodes()) {
                        options.before = parent.firstChild
                    }
                    else {
                        options.inside = parent
                    }
        ...
        // Convert an element-accepting Utopia function to one that accepts multiple elements
        multiplize: function (func) {
